...
\begin{table}[ht]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabulary}{\textwidth}{ c | c | c | c | c | c }
			...
			\thead{Applications} &
			\thead{Methods} &
			\thead{Implementation} \\ \hline
			Knowledge & \makecell{Online \\ Tracking} & Collaboration & \makecell{Speculation in \\ Search} & \makecell{Action \\ Modeling} & Explicit \\ \hline
			Position & \makecell{Online Strategy \\ Recognition} & Adversarial & Tutoring & \makecell{ Preference \\ Modeling} & Implicit \\ \hline
			Strategy & \makecell{Off-line \\ Review} & Storytelling & Training & \makecell{Position \\ Modeling} \\ \hline
			Satisfaction & & & Substitution & \makecell{Knowledge \\ Modeling} & \\ \hline
		\end{tabulary}}
\end{table}

This taxonomy can be explained through a set of questions related to a research in player modeling. The following questions are going to be used as a guideline since answering them implies in an advance in the understanding of the project at hand.
...
\begin{table}[ht]
	\centering
	\caption{Player Modeling Taxonomy Summary by \citep{SmithInclusiveTaxonomyPlayer}}
	\label{table:taxonomy2}
	\resizebox{\textwidth}{!}{%
		\begin{tabulary}{\textwidth}{ l | l | l | l }
			...
			\thead{Domain} &
			\thead{Source} \\ \hline
			\makecell[tl]{\textbf{\textit{Individual}} \\ applicable only to \\ one player} & \makecell[tl]{\textbf{\textit{Generative}} \\ literally produces \\ details in place of \\ a human player} & \makecell[tl]{\textbf{\textit{Game Actions}} \\ details recorded \\ inside of the game’s \\ rule system} & \makecell[tl]{\textbf{\textit{Induced}} \\ learned/fit/recorded \\ by algorithmic means} \\

			\makecell[tl]{\textbf{\textit{Class}} \\ applicable to a \\ sub-population} & \makecell[tl]{\textbf{\textit{Descriptive}} \\ conveys a high-level \\ description, usually \\ visually or \\ linguistically} & \makecell[tl]{\textbf{\textit{Human Reactions}} \\ details observable in \\ the player as a result \\ of play} & \makecell[tl]{\textbf{\textit{Interpreted}} \\ concluded via \\ fuzzy/subjective \\ reasoning from \\ records} \\

			\makecell[tl]{\textbf{\textit{Universal}} \\ applicable to \\ all players} & & & \makecell[tl]{\textbf{\textit{Analytic}} \\ derived purely from \\ the game’s rules and \\ related models } \\

			\makecell[tl]{\textbf{\textit{Hypothetical}} \\ unlikely to be \\ applicable to \\ any players, \\ but interesting \\ nonetheless } & & & \makecell[tl]{\textbf{\textit{Synthetic}} \\ justified by reference \\ to an internal belief or \\ external theory } \\
